...
\setbeamertemplate{footline}[text line]{%
  \parbox{\linewidth}{\vspace*{0pt}\hfill\insertframenumber/\inserttotalframenumber\hfill \includegraphics[width=0.15\textwidth]{recogizer_logo_EN_quer.png} %{recogizer_logo_small.png}
}}
